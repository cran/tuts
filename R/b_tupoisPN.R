...
#' Prints summary tables of tuts_poisPN objects
#'
...
#' Plots and visual diagnostics of tuts_poisPN objects
#'
#' \code{plot.tuts_poisPN} generates plots and visual diagnostics of tuts_poisPN objects.
#'
